...
async function injectReader(response){
 ...
 const injected=html.replace('</body>',`<script src="./${READER}" defer></script><script src="./${FIX}" defer></script><script src="./${AUTOSAVE}" defer></script><script src="./${IE}" defer></script><script src="./${MANUAL}" defer></script><script src="./${FINAL}" defer></script><script src="./${NFENTRY}" defer></script><script src="./${NFFIX}" defer></script></body>`);
